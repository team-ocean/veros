...
@pyom_method
def adv_flux_superbee_spectral(pyom,is_,ie_,js_,je_,np_,adv_fe,adv_fn,adv_ft,var,uvel,vvel,wvel):
    """
...
@pyom_method
def reflect_flux(pyom,is_,ie_,js_,je_,np_,adv_fe,adv_fn):
    """
