...
SETTINGS = OrderedDict([
    ...
    ("taum1", Setting(0, int, "Pointer to last time step")),
    ("tau", Setting(1, int, "Pointer to current time step")),
    ("taup1", Setting(2, int, "Pointer to next time step")),
    ("dt_mom", Setting(0., float, "Time step in seconds for momentum")),
    ("dt_tracer", Setting(0., float, "Time step for tracer can be larger than for momentum")),
    ("dt_tke", Setting(0., float, "Currently set to dt_mom")),
    ("itt", Setting(1, int, "Time step number")),
