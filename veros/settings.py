...
SETTINGS = OrderedDict([
    ...
    ('enable_hdf5_gzip_compression', Setting(True, bool, 'Use h5py\'s native gzip interface, which leads to smaller output files (but carries some computational overhead).')),
